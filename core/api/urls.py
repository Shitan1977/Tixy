...
from .views import (
    ...
    # abbonamenti / alert
    ScontiViewSet, AlertPlanViewSet, AbbonamentoViewSet, MonitoraggioViewSet, NotificaViewSet, EventFollowViewSet,
    # marketplace legacy
...
router.register(r'alert-plans', AlertPlanViewSet, basename='alert-plans')
